      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          <View style={styles.iconBadge}>
            <Avatar.Icon size={56} icon="shield-crown" style={styles.logoAvatar} color="#ef4444" />
          </View>
          <Text variant="headlineMedium" style={styles.brandTitle}>
            SafePassage <Text style={{ color: '#ef4444' }}>Admin Gate</Text>
          </Text>
          <Text variant="bodySmall" style={styles.subtitle}>
            Super Admin Governance & Auditing Terminal
          </Text>
        ...
        <Surface style={styles.card} elevation={3}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.roleRow}>
            {(['admin', 'parent', 'driver', 'cab_owner'] as AppRole[]).map((role) => {
          ...
          <Text variant="titleMedium" style={styles.loginTitle}>
            Sign In as <Text style={{ color: ROLE_ACCOUNTS[selectedRole].badgeColor }}>{ROLE_ACCOUNTS[selectedRole].roleLabel}</Text>
          </Text>

          <TextInput
            label="Super Admin Username / Email"
            value={usernameOrEmail}
            placeholder={`e.g. ${ROLE_ACCOUNTS[selectedRole].defaultUser}`}
            onChangeText={(text) => {
          ...
          <Button
            ...
            loading={isLoading}
            disabled={isLoading}
            style={[styles.loginBtn, { backgroundColor: ROLE_ACCOUNTS[selectedRole].badgeColor }]}
      ...
      <Portal>
        ...
        >
          <Dialog.Title style={styles.dialogTitle}>
            🔐 2FA / Emergency Override OTP
          </Dialog.Title>
          <Dialog.Content>
            <Text variant="bodySmall" style={styles.dialogDescription}>
              Enter registered root admin mobile for 2-factor OTP authorization.
            </Text>
            <TextInput
