      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          <View style={styles.iconBadge}>
            <Avatar.Icon size={56} icon="steering" style={styles.logoAvatar} color="#10b981" />
          </View>
          <Text variant="headlineMedium" style={styles.brandTitle}>
            SafePassage <Text style={{ color: '#10b981' }}>Driver Cockpit</Text>
          </Text>
          <Text variant="bodySmall" style={styles.subtitle}>
            Driver & Fleet Partner Operations Portal
          </Text>
        ...
        <Surface style={styles.card} elevation={3}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.roleRow}>
            {(['driver', 'cab_owner', 'parent', 'student', 'admin'] as AppRole[]).map((role) => {
        ...
        >
          ...
          <Dialog.Content>
            <Text variant="bodySmall" style={styles.dialogDescription}>
              Enter your driver registered mobile number.
            </Text>
            <TextInput
