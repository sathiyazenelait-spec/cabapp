@echo off
title Parent Mobile App Launcher
color 0a

echo ==================================================================
echo   Parent Mobile App - Launcher
echo ==================================================================
echo.
echo [1] Run Parent App on Mobile Device / Android Emulator (Recommended)
...
:run_app
echo.
echo Starting Parent Mobile App on Device/Emulator...
...
set "PROJECT_PATH=%~dp0frontend-mobile-parent\android"

if exist "%STUDIO_PATH%" (
    start "" "%STUDIO_PATH%" "%PROJECT_PATH%"
    echo Parent App project opened in Android Studio!
) else (
